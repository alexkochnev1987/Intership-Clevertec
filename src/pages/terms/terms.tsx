...
export const Terms = ({ contentView }: TermsContent) => (
  <div>
    {contentView === 'terms' ? <h3>Правила пользования</h3> : <h3>Договор оферты</h3>}
    <ul className='subtitle-large terms__ul'>
      <li>
        <span>
        ...
        <ul className='body-large terms__li'>
          <li>
